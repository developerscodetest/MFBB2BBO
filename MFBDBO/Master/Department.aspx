<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="MFBDBO.Master.InactiveHRM" %>
        ...
        <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table id="Department" class="table table-bordered datatable table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>Department</th>
                                <th>Status</th>
