<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Admin.Master" AutoEventWireup="true" CodeBehind="Role.aspx.cs" Inherits="MFBDBO.Master.Role" %>
  ...
  <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table id="Role" class="table table-bordered datatable table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>Role</th>
                                <th>Status</th>
