<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="BookingByReport.aspx.cs" Inherits="MFBDBO.Reports.BookingByReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminPlaceHolder" runat="server">
      ...
      <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <%--<asp:GridView ID="gdvBbySupplier" CssClass="table table-bordered datatable table-striped" runat="server" AutoGenerateColumns="False" >--%>
                        <asp:GridView ID="gdvBbyReports" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"  ShowHeader="False">
                        <Columns>
        ...
        <script type="text/javascript">
            ...
            $("#AdminPlaceHolder_gdvBbyReports").prepend($("<thead><tr><th>BookingId</th><th>Check In</th><th>Check Out</th><th>Supplier</th><th>Agency Name</th></tr></thead>").append($(this).find("tr:first")));
            $("#AdminPlaceHolder_gdvBbyReports").css('width', '100%');
            $("#AdminPlaceHolder_gdvBbyReports").dataTable({
                "pageLength": 50,
                dom: 'Bfrtip',
                buttons: [
                    {
