<%@ Page Title="" Language="C#" MasterPageFile="~/Salesmanagement/SalesManagement.Master" AutoEventWireup="true" CodeBehind="Reconformations.aspx.cs" Inherits="MFBDBO.Salesmanagement.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SalesPlaceHolder" runat="server">
     ...
     <div class="box">
        <div class="box-header">
            <h3 class="box-title">Reconformations</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
