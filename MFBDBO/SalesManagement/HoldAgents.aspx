<%@ Page Title="" Language="C#" MasterPageFile="~/Salesmanagement/SalesManagement.Master" AutoEventWireup="true" CodeBehind="HoldAgents.aspx.cs" Inherits="MFBDBO.Salesmanagement.HoldAgents" %>
...
<section class="content">
        <div class="box">
            ...
            <!-- /.box-body -->
            <div class="box-body">
            <table id="Hold" class="table table-bordered datatable table-striped">
                    <thead>
                        <tr>
                            <th>Agency Code</th>
                            <th>Agency Name</th>
