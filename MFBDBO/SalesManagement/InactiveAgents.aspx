<%@ Page Title="" Language="C#" MasterPageFile="~/Salesmanagement/SalesManagement.Master" AutoEventWireup="true" CodeBehind="InactiveAgents.aspx.cs" Inherits="MFBDBO.Salesmanagement.InactiveAgents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SalesPlaceHolder" runat="server">
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- /.box-body -->
            <div class="box-body">
            <table id="Inactive" class="table table-bordered datatable table-striped">
                    <thead>
                        <tr>
                            <th>Agency Code</th>
                            <th>Agency Name</th>
